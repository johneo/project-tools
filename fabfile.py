...
# add a creds.py file to your project-tools folder and use it to store your creds
...
def vagrant():
    """
    Setup local vagrant development instance
    """
...
def bootstrap():
    ...
    configure_gis_example_project()                 # config the sample gis project
...
def copy_wsgi_config():
    """
    Copies the wsgi file to the environemnt
    """
...
def destroy():
    """
    destroys all known aws ec2 instances
    """
...
def configure_gis_example_project():
    """
    Configure the example gis project
    """
